...
namespace Kong.Models
{
    ...
    public partial class ServiceUpsert
    {
        /// <summary>
        /// Initializes a new instance of the ServiceUpsert class.
        /// </summary>
        public ServiceUpsert()
        {
            CustomInit();
        }
        ...
        /// upstream server.</param>
        public ServiceUpsert(string name = default(string), int? retries = default(int?), string protocol = default(string), string host = default(string), int? port = default(int?), string path = default(string), int? connectTimeout = default(int?), int? writeTimeout = default(int?), int? readTimeout = default(int?))
        {
            Name = name;
            Retries = retries;
            Protocol = protocol;
