...
namespace Kong.Models
{
    ...
    public partial class Plugin
    {
        ...
        public Plugin(string name = default(string), IDictionary<string, object> config = default(IDictionary<string, object>), RoutePreview route = default(RoutePreview), ServicePreview service = default(ServicePreview), ConsumerPreview consumer = default(ConsumerPreview), string runOn = default(string), bool? enabled = default(bool?), string id = default(string), int? createdAt = default(int?))
        {
            Name = name;
            Config = config;
            Route = route;
